...
const InAirTable = () => {
    ...
    const fetchAllFlights = useCallback(async () => {
        try {
            await axios.post("http://localhost:8000/in_air");  // Ensure backend requires this
            await axios.put("http://localhost:8000/in_air");   // Ensure backend requires this
