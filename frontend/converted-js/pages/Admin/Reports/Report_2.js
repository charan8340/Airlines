...
const Report_2 = () => {
  ...
  const [targetAirport, setTargetAirport] = (0, _react.useState)('');
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Container.default, {
    ...
    component: "h1",
    variant: "h5"
  }, "Passenger Count"), /*#__PURE__*/_react.default.createElement(_Box.default, {
    component: "form",
    noValidate: true,
    sx: {
      mt: 1
  ...
  }, targetAirport.name))))), /*#__PURE__*/_react.default.createElement(_Box.default, {
    sx: {
      marginTop: 2,
      marginBottom: 3
    }
