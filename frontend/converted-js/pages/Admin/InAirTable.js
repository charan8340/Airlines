...
const InAirTable = () => {
  const [inAir, setInAir] = (0, _react.useState)([]);
  ...
  const fetchAllFlights = (0, _react.useCallback)(async () => {
    try {
      await _axios.default.post("http://localhost:8000/in_air"); // Ensure backend requires this
      await _axios.default.put("http://localhost:8000/in_air"); // Ensure backend requires this

      const res = await _axios.default.get("http://localhost:8000/in_air");
      setInAir(res.data);
    } catch (err) {
      console.error(err);
    }
  ...
  }, /*#__PURE__*/_react.default.createElement(_material.Grid, null, /*#__PURE__*/_react.default.createElement("h1", null, "Dashboard"), /*#__PURE__*/_react.default.createElement("h2", null, "Currently In Air")), /*#__PURE__*/_react.default.createElement(_material.Box, {
    sx: {
      width: '100%',
      marginTop: '5vh'
    }
...
var _default = exports.default = InAirTable;