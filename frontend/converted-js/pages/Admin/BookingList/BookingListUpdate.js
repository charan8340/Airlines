...
const BookingList_Update = () => {
  ...
  (0, _react.useEffect)(() => {
    const fetchALLModels = async () => {
      try {
        const res = await _axios.default.get("http://localhost:8000/aircraft_models");
        setCurr(res.data);
        console.log(res);
      } catch (err) {
        console.log(err);
  ...
  const handleClick = async e => {
    e.preventDefault();
    try {
      await _axios.default.put("http://localhost:8000/aircraft/" + aircraft_id, the_model);
      navigate("/aircraft");
    } catch (err) {
      console.log(err);
    }
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Container.default, {
    ...
    component: "h1",
    variant: "h5"
  }, "Update Aircraft"), /*#__PURE__*/_react.default.createElement(_Box.default, {
    component: "form",
    noValidate: true,
    sx: {
      mt: 1
...
var _default = exports.default = BookingList_Update;