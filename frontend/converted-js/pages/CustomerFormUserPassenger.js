...
exports.default = CustomerFormUserPassenger;
...
function CustomerFormUserPassenger() {
  ...
  const handleSubmit = async event => {
    ...
    try {
      const response = await _axios.default.post("http://localhost:8000/user_passenger", {
        name: name,
        date_of_birth: dob,
        address: address,
        nic: nic,
